...
collisionCenter = (650+100,400-100)
                ...
                for cIndex_2 in range(car_numbers-1):
                    if Error_list[cIndex_1][cIndex_2] > 0:
                        if dist_from_c_list[cIndex_1] > dist_from_c_list[cIndex_2]:
                            if speed[cIndex_1][cIndex_2] > 0.3 :
                                speed[cIndex_1][cIndex_2]= 0.3
                            car_speed_list[cIndex_1] = speed[cIndex_1][cIndex_2]
                        else:
                            
                            if speed[cIndex_1][cIndex_2] > 0.3 :
                                speed[cIndex_1][cIndex_2]= 0.3
                            car_speed_list[cIndex_2] = speed[cIndex_1][cIndex_2]
                        ...
                        if dist_from_c_list[cIndex_1] > dist_from_c_list[cIndex_2]:
                            ...
                            if speed[cIndex_1][cIndex_2] > 0.3 :
                                speed[cIndex_1][cIndex_2]= 0.3
                            car_speed_list[cIndex_1] = float(speed[cIndex_1][cIndex_2])
            
           
            for index in range(len(currentVechiles)):
                    
                    currentVechiles[index].setVelocity(car_speed_list[index])
